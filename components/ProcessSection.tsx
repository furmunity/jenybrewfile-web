            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">ISO 인증 생산 시설에서 제조</span>
                </div>
                <div className="flex items-center gap-3">
                  <i className="ri-check-double-line text-xl text-green-600"></i>
                  <span className="text-gray-700">전 공정 품질 관리 시스템 적용</span>
                </div>
                <div className="flex items-center gap-3">
                  <i className="ri-check-double-line text-xl text-green-600"></i>
                  <span className="text-gray-700">무첨가, 무방부제 원칙 준수</span>
                </div>
                <div className="flex items-center gap-3">
                  <i className="ri-check-double-line text-xl text-green-600"></i>
                  <span className="text-gray-700">원산지 인증서 및 품질보증서 제공</span>
                </div>
              </div>
            </div>
