      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            제니브루 USP <span className="text-amber-400">파트너와 고객 모두를 위한 차별화된 가치</span>
          </h2>
        ...
        <div className="bg-red-600 text-gray-900 font-bold rounded-3xl p-8 md:p-12 text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">
            지금이 바로, 제니브루를 선택해야 할 때입니다.
          </h3>
          <p className="text-xl text-white/90 mb-8 max-w-4xl mx-auto leading-relaxed">
            단순한 차 제품이 아닌, <strong>제니브루는 매출, 고객, 운영 모두를 혁신합니다.</strong>
            <br/>
            스틱 하나로 완성되는 프리미엄 티 경험
          </p>
