...
export default function ComparisonTable() {
  const comparisons = [
    ...
    {
      category: '준비 방식',
      traditional: '차 도구 및 우림 시간 필요',
      jenybrew: '도구 불필요, 즉시 제공 가능'
    },
    {
      category: '차잎 원산지',
      traditional: '일반적인 보이차 잎',
      jenybrew: '운남성 보이현 정품 차잎'
    },
    {
      category: '가공 방식',
    ...
    },
    {
      ...
      jenybrew: '프리미엄 패키징, 선물용 최적화 (ex.임직원,VIP 등)'
    }
  ];
        ...
        <div className="mt-12 text-center">
          <div className="bg-amber-50 rounded-2xl p-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700">
              제니브루 스틱형 보이차는 전통의 가치 <br/> 
              <span className="font-bold text-amber-600">  "ZERO TIME의 편리함과 프리미엄" </span> 
              이미지를 동시에 제공합니다. <br/> 즉, 고객에게는 건강하고 특별한 경험을, 매장에는 운영 효율과 더불어 새로운 매출 기회를 선사합니다.
            </p>
          </div>
        </div>
      </div>
