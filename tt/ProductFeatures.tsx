...
export default function ProductFeatures() {
  const features = [
    ...
    },
    {
      icon: 'ri-heart-line',
      title: '건강한 무첨가',
      description: '무설탕·무방부제·무첨가, 웰빙 트렌드 맞춤형.',
    ...
    },
    {
      icon: 'ri-gift-line',
      title: '프리미엄 선물 포장',
      description: 'VIP·기업 선물용으로 확장 가능한 고급 패키지.',
      image: '/image/gift.png'
    },
    {
      icon: 'ri-time-line',
      title: '즉석 제공 가능',
      description: '매장·행사 등에 신속한 제공으로 고객 만족 UP.',
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg">
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              커피만으로는 부족합니다.<br/> <span className="text-amber-600">보이차로 메뉴와 매출 상승을 경험해보세요.</span>
            </h3>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 hover:shadow-lg transition-all duration-300">
              ...
              <div className="bg-white rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600">커피 대체 음료로 건강 지향 고객 타겟. 기본이자 가장 안정적인 매출 카테고리.</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-2xl p-8 hover:shadow-lg transition-all duration-300 border-2 border-amber-200">
              ...
              <div className="bg-white rounded-lg p-4">
                <p className="text-sm font-semibold text-gray-800 mb-2">포지셔닝 포인트</p>
                <p className="text-sm text-gray-600">밀크티와 유사한 친숙함.<br/>20~30대 여성층에 인기.<br/>부드러운 맛으로 점심 디저트용 <br/>카페 메뉴 확장의 핵심 아이템.</p>
              </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8 hover:shadow-lg transition-all duration-300">
              ...
              <div className="bg-white rounded-lg p-4">
                <p className="text-sm font-semibold text-gray-800 mb-2">포지셔닝 포인트</p>
                <p className="text-sm text-gray-600">스페셜티 이미지로 메뉴 어필.<br/>성수·강남 등 트렌디 지역 고객</p>
              </div>
            </div>
          </div>
        </div>
